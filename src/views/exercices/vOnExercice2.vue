<template>
    <div class="container mx-auto p-4 md:p-8">
        <div class="card bg-base-100 shadow-xl rounded-box p-6">
            ...
            <div class="mt-6 mb-4 card bg-base-200 shadow-lg rounded-box p-4">
                <h6 class="text-xl font-semibold mb-2">Modificateur d'événement <code>.esc</code></h6>
                <p class="text-sm opacity-75 mb-4">
                ...
                <label class="form-control w-full">
                    ...
                    <input 
                        ...
                        class="input input-bordered w-full"
                        v-model="tempInput"
                        @keyup.esc="confirmInput"
                        />
                </label>
                <div class="mt-3 p-3 bg-base-100 rounded-box shadow">
                    <p>La valeur confirmée par 'Échap' est : <span class="badge badge-primary">{{ confirmedInput }}</span></p>
                </div>
            </div>
            ...
            <div class="mt-6 mb-4 card bg-base-200 shadow-lg rounded-box p-4">
                ...
                <button class="btn btn-error text-white" @click="alertButton">
                    Afficher une alerte
                </button>
            </div>
        </div>
...
<script setup lang='js'>
    ...
    function confirmInput(){
        confirmedInput.value = tempInput.value
    }

    function alertButton(){
        alert("Attention à l'alerte !")
    }
</script>
