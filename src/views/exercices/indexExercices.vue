<template>
    <h1 class="text-3xl">Les différents exercices</h1>
    <router-link to="/dataBinding"><button class="btn btn-wide">Data Binding</button></router-link>
    <router-link to="/von"><button class="btn btn-wide">v-on 1</button></router-link> 
